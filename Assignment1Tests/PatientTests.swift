...
struct PatientTests {
    ...
    @Test func setAllValues() async throws {
        ...
        #expect(patient.medicalRecordNumber != nil)
    }
    ...
    @Test func differentMedicalRecordNumber() async throws {
        ...
        #expect(patient1.medicalRecordNumber != patient2.medicalRecordNumber)
